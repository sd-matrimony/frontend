...
const fieldVariants = cva('group/field flex w-full gap-1 data-[invalid]:text-destructive', {
  variants: {
    orientation: {
...
function FieldLabel({ className, ...props }: React.ComponentProps<typeof FieldPrimitive.Label>) {
  return (
    <FieldPrimitive.Label
      ...
      className={cn(
        'group/field-label peer/field-label flex w-fit gap-2 text-sm font-medium leading-snug group-data-disabled/field:opacity-50 has-data-checked:border-primary/30 has-data-checked:bg-primary/5 has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10',
